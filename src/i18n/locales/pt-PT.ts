...
const messages = {
  ...
  scenarioComparison: {
    ...
    summary:
      "Veja como a tributação, a Segurança Social e os dependentes afetam o rendimento líquido.",
    explanation:
    ...
    screenOnlyNote:
      "A comparação de cenários é apenas para análise no ecrã nesta versão.",
    presets: {
      individual: {
        label: "Comparar individual",
        description: "Usa tributação individual para o mesmo rendimento.",
      },
      jointSingleIncome: {
      ...
      noDependents: {
        ...
        description:
          "Repõe o número e as faixas etárias dos dependentes a zero.",
      },
    },
    table: {
      scenario: "Cenário",
      ...
      netIncomeMonth: "Rendimento líquido / mês",
    ...
    statuses: {
      ...
      betterThanCurrent: "{amount} melhor do que o cenário atual",
      worseThanCurrent: "{amount} pior do que o cenário atual",
