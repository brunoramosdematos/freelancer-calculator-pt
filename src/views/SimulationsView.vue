<template>
  <div class="flex">
    ...
    >
      ...
      <ul v-else class="flex md:inline-flex flex-col gap-3">
        <li
        ...
        >
          ...
          <div class="flex items-center">
            <router-link
              :to="{ name: 'Simulator', query: simulation.parameters }"
              class="inline-flex group p-2"
              data-cy="open-simulation"
